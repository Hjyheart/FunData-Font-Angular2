...
var com_routing_module_1 = require("./com.routing.module");
    ...
    ComModule = __decorate([
        core_1.NgModule({
            imports: [
                forms_1.FormsModule,
                http_1.HttpModule,
                com_routing_module_1.ComRoutingModule
            ],
            declarations: [
                com_component_1.ComComponent,
                list_component_1.ComListComponent,
                detail_component_1.ComDetailComponent
            ],
            providers: []
        }), 
