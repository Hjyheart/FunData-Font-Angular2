...
var routes = [
    {
        ...
        children: [
            {
                path: 'list',
                component: list_component_1.DatasetListComponent
            },
            {
                path: 'detail/:id',
...
var DatasetRoutingModule = (function () {
    function DatasetRoutingModule() {
    }
    DatasetRoutingModule = __decorate([
        core_1.NgModule({
    ...
    return DatasetRoutingModule;
}());
exports.DatasetRoutingModule = DatasetRoutingModule;
//# sourceMappingURL=dataset.routing.module.js.map